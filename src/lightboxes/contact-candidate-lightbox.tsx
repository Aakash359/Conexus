...
export class ContactCandidateLightbox extends React.Component<
  ContactCandidateLightboxProps,
  any
> {
  ...
  _videoCall() {
    ...
    setTimeout(() => {
      videoStore.call(candidate.submissionId, candidate.userId, {
        name: candidate.firstName + ' ' + candidate.lastName,
        title: '',
        subTitle: candidate.display.description,
  ...
  render() {
    let communicationTypes: CommunicationType[] =
      this.props.candidate.communicationTypes;
    let videoChat =
      communicationTypes.filter(type => {
