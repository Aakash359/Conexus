...
import { ModalHeader, ConexusIconButton, ScreenFooterButton } from '../../components'
...
@inject('userStore')
@observer
export class AppFeedbackModal extends Component<AppFeedbackModalProps, AppFeedbackModalState> {
    ...
    _sendMessage() {
        ...
        return userStore.selectedFacility.sendFeedback(messageText) 
            .then(() => {
    ...
    render() {
        ...
        return (
            <Container>
                <ModalHeader title="App Feedback" right={() =>
