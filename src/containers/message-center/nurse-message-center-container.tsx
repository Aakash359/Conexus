...
import { ConversationStore, ConversationModel } from '../../stores/message-center'
...
@observer
export class NurseMessageCenterContainer extends React.Component<NurseMessageCenterProps, NurseMessageCenterState> {
    ...
    _renderConversationItem({ item, index }) {
        ...
        return <ListItem key={`${conversation.conversationId}`}
            avatar
    ...
    _renderConversationList() {
        const conversationStore = this.props.conversationStore as typeof ConversationStore.Type
    ...
    render() {
        ...
        if (!this.loadedWithDataOnce && conversationStore.loading) {
            return (<Container><ActivityIndicator style={{ flex: 1 }} color={AppColors.blue} /></Container>)
        }
