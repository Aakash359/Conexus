...
const InterviewQuestionDetail = (
  ...
  const [data1, setData1] = useState([
    {
      id: '26',
      text: 'Do you like questions made from a computer?',
      unitId: '0',
      unitName: 'General',
    },
    {
  ...
  const deleteInterviewQuestion = async (questionId: string, index: number) => {
    console.log('Aakash====>', questionId, index);
    let row = [...data1];
    row.splice(index, 1);
    setData1(row);
            ...
            <SortableQuestionRow
              ...
              onDeleteQuestion={() =>
                needId
                  ...
                  : deleteInterviewQuestion(question.id, index)
              }
              onOpenQuestion={() =>
                openQuestion(
                  question.id,
