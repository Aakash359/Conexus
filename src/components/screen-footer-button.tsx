...
@observer
export class ScreenFooterButton extends React.Component<ScreenFooterButtonProps, ScreenFooterButtonState>  {
        ...
        if (hideGradient) {
            return (
                <View style={styles.root}>
                    <ActionButton disabled={disabled} danger={danger} style={styles.button} primary title={title} onPress={onPress} />
                </View>
            )
        }

        return (
            <LinearGradient style={styles.root} colors={['rgba(241, 243, 248, 0)', 'rgba(241, 243, 248, .9)', AppColors.baseGray]}>
                <ActionButton disabled={disabled} danger={danger} style={styles.button} primary title={title} onPress={onPress} />
            </LinearGradient>
        )
    }
